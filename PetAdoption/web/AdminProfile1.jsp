  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link" href="#" data-bs-toggle="modal" data-bs-target="#exampleModal tabindex="-1" aria-disabled="true">Disabled</a>
        </li>
      </ul>
      <form class="d-flex">
        <a class="nav-link text-white" href="#!" data-bs-toggle="modal" data-bs-target="#exampleModal"><%=admin.getAdminName()%>  
        </a>>
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <tbody>
      <tr>
        <img src="img/profile_img.jpg" alt="" style="height:115px; width:175px;"/>
      </tr>
    <tr>
    ...
    <tr>
      ...
      <div class="modal-footer">
        ...
        <button  id="edit-profile-button" type="button" class="btn"style="background-color: #1c1d1b">Edit</button>
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">
            
        <a class="nav-link text-white" href="#!" data-bs-toggle="modal" data-bs-target="#delete-modal">Delete</button>
