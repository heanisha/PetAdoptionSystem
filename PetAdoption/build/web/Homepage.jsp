    ...
    <div class="jumbotron">
        <div class="container-fluid">
            <div class="header-content-inner">
                 &nbsp; &nbsp; 
                <h10><a href="About&Contact.jsp" style="font-size:20px; color:black; text-shadow: black 0.0em 0.0em 0.0em;"><u>ABOUT US</u></a></h10> 
                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 
                <h10><a href="About&Contact.jsp" style="font-size:20px; color:black; text-shadow: black 0.0em 0.0em 0.0em;"><u>CONTACT US</u></a></h10>   
                <h2 style="font-size:40px"></h2>
                <div class="container" style="width:50%; margin-left:20px;">
                   <h9 style="font-size:90px; color:black; text-shadow: black 0.0em 0.0em 0.0em;"><b>ADOPT A PET TODAY</b></h9>
    </div>
                <div class="container" style=" margin-left:41%; margin-top:150px;">
                <button type="button" class="btn-dark" style="height:35px; width:125px;" onclick="window.location.href = 'adminRegister_Page.jsp';">REGISTER</button>
                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                <button type="button" class="btn-dark" style="height:35px; width:125px;" onclick="window.location.href = 'adminLogin_page.jsp';">LOG IN</button>
            </div>
                </div>
        </div>
    </div>
