...
import com.pet.adoption.dao.AdminDao;
...
public class AdminLoginServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            String adminadminEmail=request.getParameter("adminEmail");
            String adminadminPassword=request.getParameter("adminPassword");
            
            AdminDao dao = new AdminDao(ConnectionProvider.getConnection());
            
            Admin u=dao.getAdminByNameAndPassword(adminadminEmail, adminadminPassword);
